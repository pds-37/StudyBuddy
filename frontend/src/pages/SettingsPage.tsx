            ...
            <div className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 space-y-8">
              <div className="flex items-center gap-6">
                <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-brand to-cyan p-[1px]">
                  <div className="w-full h-full rounded-full bg-obsidian flex items-center justify-center text-white text-3xl font-black">
          ...
          <section className="space-y-6">
            ...
            <div className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 space-y-6">
              <div className="flex items-center justify-between p-4 rounded-2xl bg-white/[0.02] border border-white/5">
                ...
                <button 
                  onClick={toggleTheme}
                  className="px-6 py-2 rounded-xl bg-brand text-white text-xs font-black uppercase tracking-widest shadow-glow"
                >
