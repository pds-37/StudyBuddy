        ...
        >
          <div className="p-6 space-y-6 min-w-[320px]">
             <button 
               ...
               className="w-full p-4 rounded-2xl bg-white text-obsidian flex items-center justify-center gap-3 font-black text-xs uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-xl"
             >
                     ...
                     <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                        {suggestedPrompts.map(prompt => (
                          <button
                            ...
                            className="group p-5 rounded-3xl glass border-white/5 bg-white/[0.02] hover:bg-white/[0.05] hover:border-brand/30 transition-all text-left relative overflow-hidden"
                          >
  ...
  return (
    ...
    >
      <div className={cn(
        ...
        isUser 
          ? "bg-white text-obsidian border-white shadow-xl" 
