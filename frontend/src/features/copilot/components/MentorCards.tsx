  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div>
          <h4 className="text-sm font-black text-white mb-1 uppercase tracking-wider">{title}</h4>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-4">
         ...
         <h4 className="text-sm font-black text-white uppercase tracking-widest">Focus Sprint</h4>
      </div>
