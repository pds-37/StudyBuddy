  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-white">Live Market Jobs</h2>
          <p className="text-slate-400">Current openings aggregated from major job sources and ranked to your profile.</p>
        </div>
        <button
