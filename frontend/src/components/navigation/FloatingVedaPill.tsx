    ...
    >
      <div className="relative group">
        <button 
          ...
          className={cn(
            "flex items-center gap-4 rounded-full bg-slate-900/90 border border-slate-200 dark:border-slate-200 dark:border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl transition-all duration-500 ease-in-out hover:border-brand/40",
        ...
        >
          <div className={cn(
            ...
            {isReduced ? <MessageSquare className="w-5 h-5 text-slate-900 dark:text-slate-900 dark:text-white" /> : <Sparkles className="w-5 h-5 text-slate-900 dark:text-slate-900 dark:text-white" />}
          </div>
          ...
          {!isReduced && (
            ...
            >
              <div>
                ...
                <p className="text-sm font-bold text-slate-900 dark:text-slate-900 dark:text-white leading-none whitespace-nowrap">What should I do right now?</p>
              </div>
        ...
        {!isReduced && (
          <button
            ...
            className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-slate-800 border border-slate-200 dark:border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-500 dark:text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-slate-900 dark:text-white hover:bg-slate-700 transition-all opacity-0 group-hover:opacity-100 shadow-lg"
          >
            <X size={12} />
          </button>
        )}
