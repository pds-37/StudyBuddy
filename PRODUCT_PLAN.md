...
* **Roadmap Engine**: Gemini-powered. Converts targetRoles/skill gaps into micro tasks.
...
## 6. 🗄️ Database Design
* **User**: `targetRoles[]`, `currentSkills[]`, `availableHours`, `BehaviorProfile`
...
## 8. 🚀 Build Roadmap
* **Phase 1 (MVP)**: Roadmap generation, Task breakdown, Simple dashboard, Chat (Groq).
